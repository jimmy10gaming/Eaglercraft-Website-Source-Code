...
const EAGLER_1_8_WASM_CLIENT = "/mc/1.8.8-wasm/";
const EAGLER_1_12_CLIENT = "/mc/1.12.2/";
const EAGLER_1_12_WASM_CLIENT = "/mc/1.12.2-wasm/";
...
const EAGLER_B1_7_3_CLIENT = "/mc/b1.7.3/";
const SCRATCH_EDITION_CLIENT = "/mc/scratch/";
...
const EAGLER_1_8_OFFLINE = [ "https://bafybeihihxpxq4nowjkse67tgyx5yljhsgbsvmo2qiq7ookm5whmylmhr4.ipfs.dweb.link/?filename=EaglercraftX_1.8_Offline_Download.zip", "EaglercraftX_1.8_Offline_Download.zip" ];
const EAGLER_1_8_WASM_OFFLINE = [ "https://bafybeidtmtattvhd2y45dbafncqmu52bxjr3kwyrftky552bpnomy2vzpu.ipfs.dweb.link/?filename=EaglercraftX_1.8_WASM-GC_Offline_Download.zip", "EaglercraftX_1.8_WASM-GC_Offline_Download.zip" ];
const EAGLER_1_12_OFFLINE = [ "https://bafybeifkhdmjy2phs5w67537wmbeer2upt5culejvbigct6i2gk26t65qy.ipfs.dweb.link/?filename=Eaglercraft_1.12_Offline_Download.zip", "Eaglercraft_1.12_Offline_Download.zip" ];
const EAGLER_1_12_WASM_OFFLINE = [ "https://bafybeia6z4k53c5ta26g3m37kvmorcpfo3rvo4ashefxxmikvq3wouboda.ipfs.dweb.link/?filename=Eaglercraft_1.12_WASM_Offline_Download.zip", "Eaglercraft_1.12_WASM_Offline_Download.zip" ];
const EAGLER_1_5_OFFLINE = [ "https://bafybeidbtfaelrb6ras6llgwee5z6inve347s4qabuffvplezyamdojhfy.ipfs.dweb.link/?filename=Offline_Download_Version.zip", "Offline_Download_Version.zip" ];
...
const EAGLER_B1_7_3_OFFLINE = [ "https://bafybeid4rbadtc4qyedeup4b3tgj3k5nqz3zas6rs2nqzjcgi22mht463y.ipfs.dweb.link/?filename=Beta_Offline_Download.zip", "Beta_Offline_Download.zip" ];
const SCRATCH_EDITION_OFFLINE = [ "https://bafybeidedkjomgv67sxmpfpc4f24ufytqxiaxxz4ph2jroinlet3rmkg7a.ipfs.dweb.link/?filename=Scratch_Edition_Offline.zip", "Scratch_Edition_Offline.zip" ];
